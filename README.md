...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aeppl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13561&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aeppl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aeppl` can be installed with:

```
conda install aeppl
```

It is possible to list all of the versions of `aeppl` available on your platform with:
